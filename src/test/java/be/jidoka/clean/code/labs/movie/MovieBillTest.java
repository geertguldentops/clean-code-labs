...
class MovieBillTest {
	...
	@Test
	void finishPurchaseWithOneSeniorTicket() {
		bill.startPurchase(90, MONDAY, false, false);
		bill.addTicket(65, false);

		double result = bill.finishPurchase();
		assertThat(result).isCloseTo(6, offset(0.01));
	}

	@Test
	void finishPurchaseWithOneSeniorAndStudentTicket() {
		bill.startPurchase(90, MONDAY, false, false);
	...
	@Test
	void finishPurchaseWithOneChildTicket() {
		bill.startPurchase(90, MONDAY, false, false);
		bill.addTicket(12, false);

		double result = bill.finishPurchase();
		assertThat(result).isCloseTo(5.5, offset(0.01));
	}

	@Test
	void finishPurchaseWithOneDefaultTicketAnd3DPurchase() {
		bill.startPurchase(90, MONDAY, false, true);
		bill.addTicket(42, false);

		double result = bill.finishPurchase();
		assertThat(result).isCloseTo(14, offset(0.01));
	}
